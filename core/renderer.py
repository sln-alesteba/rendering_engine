...
class Renderer(object):
    ...
    def render(self, scene, camera):
        ...
        for mesh in meshList:
            ...
            # update uniforms stored in the material
    ...
    def toScreenSpace(self, camera, point):
        
        return camera.projectionMatrix @ camera.viewMatrix @ point.getWorldMatrix() @ [0.0, 0.0, 0.0, 1.0]
